...
const ProjectSection = () => {
  const projectsArray = [
    {
      title: "Project 1",
      descr: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque blanditiis nemo fugit autem possimus, magnam consequatur sint esse.",
      codeLink: "#",
      previewLink: "#"
    },
    {
  ...
  // const [listProject, setListProject] = useState(projectsArray)
  ...
  return (
    <div className="projects-section-container">
      ...
      <div className="text">
        <h2>Projects 🚀</h2>
        <p>
          I have worked on a variety of projects that showcase my expertise in full-stack development, API
          integrations, and scalable web applications. From dynamic user interfaces to robust backend systems,
          my projects reflect my ability to solve complex problems with clean and efficient code.

          Each project is built with a focus on performance, security, and user experience, utilizing modern
          technologies like <b> React.js, Next.js, Angular, Node.js, MongoDB, MySQL, and Web3
            integrations.</b>
          ...
          <div className="card">
            ...
            <div className="card__descr-wrapper">
              ...
              <div className="card__links">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" className="svg">&lt;<path
                  ...
                  <a className="link" href={list?.previewLink}>Preview</a>
                </div>
                <div>
                  ...
                  <a className="link" href={list?.codeLink}>Code</a>
                </div>
              </div>
            </div>
          </div>)
