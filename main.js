...
//     {
//         title: "Project 1",
//         description: "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Atque blanditiis nemo fugit autempossimus, magnam consequatur sint esse.",
//         codeLink: "#",
//         previewLink: "#"
//     },
//     {
...
// const projectSection = document.querySelector(".projects-section .cards");
...
//                             <div>
//                                 <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" class="svg">&lt;<path
...
//                                     </path></svg>
//                                 <a class="link" href="${project.codeLink}">Code</a><a class="link" href="${project.previewLink}">Preview</a>
//                             </div>
//                             <div>
...
//                                     </path>
//                                 </svg>
//                                 <a class="link" href="${project.link}">Code</a>
//                             </div>
//                         </div>
//                     </div>
// `;
